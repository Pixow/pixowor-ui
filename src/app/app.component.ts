...
export class AppComponent {
  ...
  public stateText: string =
    ' This is the inspector . Here you can enable or disable an Entity , . Here you can enable or disable an En';
  public useText: string =
    'If you want to add behaviors to your Entity click on Add Component How are you Im fine thank ';
